...
7. **Деплой на Vercel** - СДЕЛАНО, ДОСТУПНО НА HTTPS://BEERBANK.VERCEL.APP.
...
10. **Лендинг** _Результат: по корневому URL открывается страница с описанием приложения. Приложение доступно по отдельному пути.
